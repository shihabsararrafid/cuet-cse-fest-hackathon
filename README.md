...
This project uses **GitHub Actions** for continuous integration and continuous deployment. Every push and pull request automatically runs through our CI/CD pipeline.
...
```
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│  Lint & Format  │───▶│   E2E Tests     │───▶│  Docker Build   │
│                 │    │                 │    │                 │
│ • ESLint        │    │ • API Tests     │    │ • Production    │
│ • Prettier      │    │ • Health Checks │    │   Image Build   │
│ • Code Style    │    │ • Integration   │    │ • Layer Cache   │
└─────────────────┘    └─────────────────┘    └─────────────────┘
```
...
- 📊 **Test Results Upload** - Artifacts available for 7 days
- 🔄 **Concurrency Control** - Cancels outdated runs automatically
- ⏱️ **Timeout Protection** - Prevents stuck jobs (10-20 min limits)
- 📝 **Job Summaries** - Beautiful summary reports in GitHub UI
...
- [ ] Docker builds successfully (if modified)
...
1. Go to the [Actions tab](https://github.com/bongodev/cuet-micro-ops-hackthon-2025/actions)
2. Click on your commit or PR
3. View logs for each job (Lint, Test, Build)
4. Download artifacts (Docker images, test results)
...
1. Go to [Actions tab](https://github.com/bongodev/cuet-micro-ops-hackthon-2025/actions)
